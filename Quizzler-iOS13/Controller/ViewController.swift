...
class ViewController: UIViewController {
    ...
    @objc func updateUi() {
        ...
        choiceOneButton.setTitle(quizBrain.getAnswers(0), for: .normal)
        choiceTwoButton.setTitle(quizBrain.getAnswers(1), for: .normal)
        choiceThreeButton.setTitle(quizBrain.getAnswers(2), for: .normal)
    }
}
